...
class CommonComments extends React.Component {
	...
	componentDidMount() {
		...
		fetch("http://newsapi.gugujiankong.com/Handler.ashx?action=getcomments&uniquekey=" + this.props.uniquekey, myFechOptions)
	...
	handleSubmit(e) {
		...
		fetch("http://newsapi.gugujiankong.com/Handler.ashx?action=comment&userid=" + localStorage.userid + "&commnet=" + formdata.remark + "&uniquekey=" + this.props.uniquekey, myFetchOptions)
			.then(response=>response.json())
			.then(json=> {
